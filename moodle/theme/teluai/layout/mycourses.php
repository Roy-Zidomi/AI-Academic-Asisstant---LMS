<?php
// Custom mycourses layout for AI-AA LMS.
...
// Add the custom body class for the mycourses page
$bodyattributes = $OUTPUT->body_attributes(['telu-page-mycourses']);
...
$editswitch = '';
// Hide the Edit mode switch if the user has switched roles (e.g. masquerading as a student)
$isroleswitched = !empty($USER->access['rsw']);
if (!$isroleswitched && method_exists($OUTPUT, 'edit_switch')) {
...
echo $OUTPUT->render_from_template('theme_teluai/mycourses', $templatecontext);
