<?php
// Custom admin layout for AI-AA LMS.
...
// Add the custom body class for the admin page
$bodyattributes = $OUTPUT->body_attributes(['telu-page-admin']);
...
echo $OUTPUT->render_from_template('theme_teluai/admin', $templatecontext);
