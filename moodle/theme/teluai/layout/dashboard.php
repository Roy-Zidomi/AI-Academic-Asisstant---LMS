<?php
// Custom dashboard layout for AI-AA LMS.
...
// Add the custom body class for the dashboard
$bodyattributes = $OUTPUT->body_attributes(['telu-page-dashboard']);
...
echo $OUTPUT->render_from_template('theme_teluai/dashboard', $templatecontext);
